...
module.exports = function (app) {
    ...
    api.setStark = function (req, res) {
        var GlobalDiscount=0.06;
       ...
       //{"id":"5","name":"Ark Reactor","price":8001,"discount":0.09,"quantityfordiscounting":3}
        console.log('set Stark: ' + JSON.stringify(req.body));
        var information = req.body.products;
        var values = JSON.parse('[{"id":"4","name":"Solar Reactor","price":4500,"discount":0.15,"quantityfordiscounting":3},{"id":"5","name":"Ark Reactor","price":8001,"discount":0.09,"quantityfordiscounting":3}]');      // var cost = mongoose.model('ProductsValue').find()
       // console.log(cost);
       var id=makeid();
       var total_cost=0.0;
