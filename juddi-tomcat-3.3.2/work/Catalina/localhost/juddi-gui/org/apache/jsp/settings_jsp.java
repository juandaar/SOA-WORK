 ...
 * Generated at: 2016-10-19 01:53:36 UTC
...
public final class settings_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/user/banner.jsp", Long.valueOf(1421183240000L));
    _jspx_dependants.put("/csrf.jsp", Long.valueOf(1421182862000L));
    _jspx_dependants.put("/header-top.jsp", Long.valueOf(1418075078000L));
    _jspx_dependants.put("/login.jsp", Long.valueOf(1421182862000L));
    _jspx_dependants.put("/autoLogoutModal.jsp", Long.valueOf(1421182862000L));
    _jspx_dependants.put("/header-bottom.jsp", Long.valueOf(1421182862000L));
  }
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("\n");
      out.write("            <hr>\n");
      out.write("            <h2>Node Management</h2>\n");
      out.write("            <a class=\"btn btn-primary\" href=\"javascript:newNode();\"><i class=\"icon-large icon-plus-sign\"></i> ");
      out.print(ResourceLoader.GetResource(session, "actions.add"));
      out.write("</a>\n");
      ...
      out.write("            });\n");
      out.write("        }\n");
      out.write("        function editNode(node) {\n");
      out.write("            var url = 'ajax/settings.jsp';\n");
      out.write("            var postbackdata = new Array();\n");
      out.write("\n");
      out.write("            postbackdata.push({\n");
      ...
      out.write("                window.console && console.log('postback done ' + url);\n");
      out.write("\n");
      out.write("                $(\"#alterNodeModalContent\").html(msg);\n");
      out.write("                $(\"#alterNodeModal\").modal();\n");
      out.write("            });\n");
      out.write("\n");
      out.write("            request.fail(function (jqXHR, textStatus) {\n");
      out.write("                window.console && console.log('postback failed ' + url);\n");
      ...
      out.write("\n");
      out.write("        }\n");
      out.write("        function newNode() {\n");
      out.write("            $(\"#newNodeModal\").modal('show');\n");
      out.write("\n");
      out.write("        }\n");
      out.write("        function saveNewNode() {\n");
      out.write("            var url = 'ajax/settings.jsp';\n");
      out.write("            var postbackdata = new Array();\n");
      out.write("\n");
      out.write("            postbackdata.push({\n");
      ...
      out.write("                value: $(\"#nonce\").val()\n");
      out.write("            });\n");
      out.write("            $(\".crudnode\").each(function ()\n");
      out.write("            {\n");
      out.write("                var id = $(this).attr(\"id\");\n");
      ...
      out.write("\n");
      out.write("                $(\"#alert_results\").html('<i class=\"icon-2x icon-thumbs-up\"></i><br>' + msg);\n");
      out.write("                $('#newNodeModal').modal('hide');\n");
      out.write("                $(\"#alert\").modal();\n");
      out.write("            });\n");
      out.write("\n");
      out.write("            request.fail(function (jqXHR, textStatus) {\n");
      ...
      out.write("                value: $(\"#nonce\").val()\n");
      out.write("            });\n");
      out.write("            $(\".crudnodeAlter\").each(function ()\n");
      out.write("            {\n");
      out.write("                var id = $(this).attr(\"id\");\n");
      out.write("                var value = $(this).val();\n");
      out.write("                postbackdata.push({\n");
      ...
      out.write("            request.done(function (msg) {\n");
      out.write("                window.console && console.log('postback done ' + url);\n");
      out.write("                $('#alterNodeModal').modal('hide');\n");
      out.write("                $(\"#alert_results\").html('<i class=\"icon-2x icon-thumbs-up\"></i><br>' + msg);\n");
      out.write("                $(\"#alert\").modal();\n");
      out.write("               \n");
      out.write("                \n");
      ...
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <div class=\"modal hide fade container\" id=\"newNodeModal\">\n");
      out.write("        <div class=\"modal-header\">\n");
      out.write("            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n");
      out.write("            <h3>");
      out.print(ResourceLoader.GetResource(session, "items.settings.add"));
      out.write("</h3>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"modal-body\" id=\"newNodeContent\">\n");
      out.write("            ");
      ...
      out.write("</div>\n");
      out.write("        <div class=\"modal-footer\">\n");
      out.write("            <a href=\"javascript:saveNewNode();\" class=\"btn btn-primary\">");
      out.print(ResourceLoader.GetResource(session, "actions.add"));
      out.write("</a>\n");
      out.write("            <a href=\"javascript:$('#newNodeModal').modal('hide');\" class=\"btn\">");
      out.print(ResourceLoader.GetResource(session, "modal.close"));
      out.write("</a>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("        <div class=\"modal hide fade container\" id=\"alterNodeModal\">\n");
      out.write("        <div class=\"modal-header\">\n");
      out.write("            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n");
      out.write("            <h3>");
      out.print(ResourceLoader.GetResource(session, "items.settings.edit"));
      out.write("</h3>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"modal-body\" id=\"alterNodeModalContent\">\n");
      out.write("           \n");
      out.write("        </div>\n");
      out.write("        <div class=\"modal-footer\">\n");
      out.write("            <a href=\"javascript:saveNode();\" class=\"btn btn-primary\">");
      out.print(ResourceLoader.GetResource(session, "actions.save"));
      out.write("</a>\n");
      out.write("            <a href=\"javascript:$('#alterNodeModal').modal('hide');\" class=\"btn\">");
      out.print(ResourceLoader.GetResource(session, "modal.close"));
      out.write("</a>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
